...
class MyReservationInConstruction extends React.Component {
  ...
  handleSelectReservation = reservationId => {
    this.props.handleSetShowingReservationId(reservationId);
...
const mapDispatchToProps = dispatch => ({
  ...
  handleSetShowingReservationId: payload => dispatch(setShowingReservationIdAction(payload))
});
